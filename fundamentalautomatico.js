...
window.onload = function() {
    // Usando allorigins como proxy mais flexível
...
function exportarMontadorCSV() {
    ...
    if (nomeBase.trim() === "") nomeBase = "Quadro_Automatico";
